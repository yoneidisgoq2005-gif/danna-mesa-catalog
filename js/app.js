      ...
      if (service.retouchAvailable) {
        retouchHtml = `
          <div class="retouch-box">
            ...
            ${service.retouch15_21 ? `<div class="retouch-row"><span>Retoque (15 a 21 días)</span><b>${this.state.formatMoney(service.retouch15_21)}</b></div>` : ''}
            ${service.retouch15_17 ? `<div class="retouch-row"><span>Retoque (15 a 17 días)</span><b>${this.state.formatMoney(service.retouch15_17)}</b></div>` : ''}
            ${service.retouch18_21 ? `<div class="retouch-row"><span>Retoque (18 a 21 días)</span><b>${this.state.formatMoney(service.retouch18_21)}</b></div>` : ''}
          </div>
        `;
      }
